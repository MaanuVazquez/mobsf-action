...
set +e
python3 manage.py createsuperuser --noinput --email "" 2&>> manage.out
set -e
python3 manage.py create_roles 2&>> manage.out
gunicorn -b 127.0.0.1:8000 "mobsf.MobSF.wsgi:application" --workers=1 --threads=10 --timeout=3600 \
